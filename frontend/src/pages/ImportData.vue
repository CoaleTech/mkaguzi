  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-lg border border-gray-200">
      ...
      <div class="p-6">
        ...
        <div v-else-if="currentMode === 'run-import'" class="text-center py-12">
          <div class="max-w-md mx-auto">
            <PlayIcon class="h-16 w-16 text-purple-500 mx-auto mb-4" />
            ...
            <div class="space-y-6">
              ...
              <div class="bg-white border border-gray-200 rounded-lg p-6">
                <div class="flex items-center justify-between mb-6">
                  <h2 class="text-lg font-medium text-gray-900">Business Central Data Explorer</h2>
                  <div class="flex items-center space-x-3">
                    <Select
                      ...
                      class="w-48"
                    />
                    <Button @click="refreshBCData" :loading="loading">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 class="text-lg font-medium text-gray-900 mb-4">Trends Over Time</h3>
                  <div class="h-64">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-lg border border-gray-200 p-6">
        <div class="flex items-center">
          <div class="p-2 bg-purple-100 rounded-lg">
            <MapIcon class="h-6 w-6 text-purple-600" />
          </div>
          <div class="ml-4">

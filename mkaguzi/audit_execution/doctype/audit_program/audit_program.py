...
@frappe.whitelist()
def get_program_progress_details(program_name):
	"""Get detailed progress information"""
	doc = frappe.get_doc("Audit Program", program_name)
	if not doc.program_procedures:
		return {
			"total": 0,
			"completed": 0,
			"in_progress": 0,
